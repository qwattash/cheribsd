...
const char *freebsd64_syscallnames[] = {
	...
	"compat14.freebsd64_getgroups",		/* 79 = freebsd14 freebsd64_getgroups */
	"compat14.freebsd64_setgroups",		/* 80 = freebsd14 freebsd64_setgroups */
	"getpgrp",			/* 81 = getpgrp */
	"setpgid",			/* 82 = setpgid */
	...
	"freebsd64_getgroups",			/* 595 = freebsd64_getgroups */
	"freebsd64_setgroups",			/* 596 = freebsd64_setgroups */
	"jail_attach_jd",			/* 597 = jail_attach_jd */
	"jail_remove_jd",			/* 598 = jail_remove_jd */
	"#599",			/* 599 = kexec_load */
	"freebsd64_pdrfork",			/* 600 = freebsd64_pdrfork */
	"freebsd64_pdwait",			/* 601 = freebsd64_pdwait */
};
