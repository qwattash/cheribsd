...
struct freebsd64_fcntl_args {
	...
	char arg_l_[PADL_(freebsd64_intptr_t)]; freebsd64_intptr_t arg; char arg_r_[PADR_(freebsd64_intptr_t)];
};
...
struct freebsd64_jail_args {
	char jail_l_[PADL_(struct jail64 *)]; struct jail64 * jail; char jail_r_[PADR_(struct jail64 *)];
};
...
struct freebsd64_kcmp_args {
	...
	char type_l_[PADL_(int)]; int type; char type_r_[PADR_(int)];
	char idx1_l_[PADL_(freebsd64_uintptr_t)]; freebsd64_uintptr_t idx1; char idx1_r_[PADR_(freebsd64_uintptr_t)];
	char idx2_l_[PADL_(freebsd64_uintptr_t)]; freebsd64_uintptr_t idx2; char idx2_r_[PADR_(freebsd64_uintptr_t)];
};
...
int	freebsd64_pdrfork(struct thread *, struct freebsd64_pdrfork_args *);
int	freebsd64_pdwait(struct thread *, struct freebsd64_pdwait_args *);
...
struct freebsd14_freebsd64_getgroups_args {
	char gidsetsize_l_[PADL_(int)]; int gidsetsize; char gidsetsize_r_[PADR_(int)];
	char gidset_l_[PADL_(gid_t *)]; gid_t * gidset; char gidset_r_[PADR_(gid_t *)];
};
struct freebsd14_freebsd64_setgroups_args {
	char gidsetsize_l_[PADL_(int)]; int gidsetsize; char gidsetsize_r_[PADR_(int)];
	char gidset_l_[PADL_(const gid_t *)]; const gid_t * gidset; char gidset_r_[PADR_(const gid_t *)];
};
int	freebsd14_freebsd64_getgroups(struct thread *, struct freebsd14_freebsd64_getgroups_args *);
int	freebsd14_freebsd64_setgroups(struct thread *, struct freebsd14_freebsd64_setgroups_args *);
...
#define	FREEBSD64_SYS_AUE_freebsd14_freebsd64_getgroups	AUE_GETGROUPS
#define	FREEBSD64_SYS_AUE_freebsd14_freebsd64_setgroups	AUE_SETGROUPS
...
#define	FREEBSD64_SYS_AUE_freebsd64_pdrfork	AUE_PDRFORK
#define	FREEBSD64_SYS_AUE_freebsd64_pdwait	AUE_PDWAIT
